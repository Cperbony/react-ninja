...
it('reduce([1, 2, 3], (acc, item) => acc + item, 0) should return 9', () => {
...
it('reduce([1, 2], (acc, item) => {acc["number-1" + item]=item; return acc }, {}) should return {"number-1": 1, "number-2":2}', () => {
...
it('reduce([1, 2]), (acc, item, index, array) => acc + arr[index], 0) should return 3', () => {
